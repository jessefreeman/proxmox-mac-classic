...
RETRO_MAC_BOOT_IMAGE="${RETRO_MAC_BOOT_IMAGE:-/dev/disk/by-id/scsi-0QEMU_QEMU_HARDDISK_drive-scsi3}"
RETRO_MAC_EXTRA_DISK="${RETRO_MAC_EXTRA_DISK:-/mnt/retro-mac-data/images/working/mac-exchange.img}"
...
run_firstboot() {
  log "Preparing RETRODATA, Macintosh HD, and Mac Exchange"
